      ...
      <main class="workspace">
        <aside class="layer-panel" id="layer-panel">
          <div class="layer-panel-header">
            ...
            <div class="layer-header-actions">
              <button class="icon-btn" id="layers-expand" title="Expand all layers" aria-label="Expand all layers">
              ...
              <button class="icon-btn" id="layer-collapse" title="Collapse layer panel" aria-label="Collapse layer panel">
        ...
        <section class="canvas-area" id="canvas-area">
          ...
          <div class="stage-scroll" id="stage-scroll">
            <div class="stage-size" id="stage-size">
